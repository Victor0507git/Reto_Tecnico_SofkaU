 ...
 */
public class clsPreguntasNivel1 {
    ...
    private String respuesta[] = {
        "A. 2,B. 3, C. 4,D. 6", "A. 2,B. 4, C. 8,D. 6", "A. 2,B. 9, C. 8,D. 6",
        "A. 12,B. 9, C. 8,D. 7", "A. 12,B. 11, C. 14,D. 10"};
    clsConexion objCon = new clsConexion();

    //Constructores
    public clsPreguntasNivel1() {
    }
    public clsPreguntasNivel1(int preguntas) {
    ...
    public String jugador(){
        ...
        System.out.print("Digite su codigo de jugador : ");
        setCodigo(entrada.nextLine());
        return getCodigo();
    }
    ...
    public String toString() {
        return "Ronda #1: La suma de " + opcion[getPreguntas()] + " es: " + respuesta[getPreguntas()];
    }
    ...
    public void guardar() {
        try {
            ...
            objCon.Sql.setString(5, "Ronda 1");
